...
public class MonsterCard extends Card {
    ...
    public static void addMonster() {
        ...
        allMonsterCards.add(new MonsterCard("Axe Raider", "Normal", "Warrior",
                ...
                Attribute.EARTH, 1700, 1150, 3100));
        allMonsterCards.add(new MonsterCard("Yomi Ship", "Model.Effect", "Aqua", 3,
                "If this card is destroyed by battle and sent to GY:Destroy the monster that destroyed this card",
                Attribute.WATER, 800, 1400, 1700));
        ...
        allMonsterCards.add(new MonsterCard("Silver Fang", "Normal", "Beast", 3,
                ...
                Attribute.EARTH, 1200, 800, 1700));
        allMonsterCards.add(new MonsterCard("Suijin", "Model.Effect", "Aqua", 7,
        ...
        allMonsterCards.add(new MonsterCard("Hero of the east", "Normal", "Warrior", 3,
                ...
                Attribute.EARTH, 110, 1000, 1700));
        allMonsterCards.add(new MonsterCard("Battle warrior", "Normal", "Warrior", 3,
                "A warrior that flights with bare hands!!!", Attribute.EARTH, 700, 1000, 1300));
        allMonsterCards.add(new MonsterCard("Crawling dragon", "Normal", "Dragon", 5,
                ...
                Attribute.EARTH, 1600, 1400, 3900));
        ...
        allMonsterCards.add(new MonsterCard("Blue-Eyes white dragon", "Normal", "Dragon",
                ...
                Attribute.LIGHT, 3000, 2500, 11300));
        allMonsterCards.add(new MonsterCard("Crab Turtle", "Ritual", "Aqua", 8,
                "This monster can only be Ritual Summoned with the Ritual Spell Model.Card, \"Turtle Oath\". You must " +
                        "also offer monsters whose total Level Stars equal 8 or " +
                        "more as a Tribute from the field or your hand.", Attribute.WATER, 2550, 2500, 10200));
        allMonsterCards.add(new MonsterCard("Skull Guardian", "Ritual", "Warrior", 7,
                "This monster can only be Ritual Summoned with the Ritual Spell Model.Card, \"Novox's Prayer\". You " +
                        "must also offer monsters whose total Level Stars equal 7 or more as a Tribute from the field or " +
                        "your hand.", Attribute.LIGHT, 2050, 2500, 7900));
        allMonsterCards.add(new MonsterCard("Slot Machine", "Normal", "Machine", 7,
                ...
                Attribute.DARK, 2000, 2300, 7500));
        allMonsterCards.add(new MonsterCard("Haniwa", "Normal", "Rock", 2,
                "An earthen figure that protects the tomb of an ancient ruler.",
                Attribute.EARTH, 500, 500, 600));
        allMonsterCards.add(new MonsterCard("Man-Eater Bug", "Model.Effect", "Insect", 2,
                "FLIP: Target 1 monster on the field; destroy that target.",
                Attribute.EARTH, 450, 600, 600));
        allMonsterCards.add(new MonsterCard("Gate Guardian", "Model.Effect", "Warrior", 11,
                ...
                Attribute.DARK, 3750, 3400, 20000));
        allMonsterCards.add(new MonsterCard("Scanner", "Model.Effect", "Machine", 1,
                "Once per turn, you can select 1 of your opponent's monsters that is removed from play. Until " +
                        ...
                        "the same Model.Attribute, Level, ATK, and DEF as the selected monster. If this card is removed from " +
                        "the field while this effect is applied, remove it from play.",
                Attribute.LIGHT, 0, 0, 8000));
        allMonsterCards.add(new MonsterCard("Bitron", "Normal", "Cyberse", 2,
                ...
                Attribute.EARTH, 200, 2000, 1000));
        allMonsterCards.add(new MonsterCard("Marshmallon", "Model.Effect", "Fairy", 3,
                ...
                Attribute.LIGHT, 300, 500, 700));
        allMonsterCards.add(new MonsterCard("Beast King Barbaros", "Model.Effect", "Beast-Warrior", 8,
                ...
                Attribute.EARTH, 3000, 1200, 9200));
        allMonsterCards.add(new MonsterCard("Texchanger", "Model.Effect", "Cyberse", 1,
                ...
                Attribute.DARK, 100, 100, 200));
        allMonsterCards.add(new MonsterCard("Leotron", "Normal", "Cyberse", 4,
                "A territorial electronic monster that guards its own domain.",
                Attribute.EARTH, 2000, 0, 2500));
        allMonsterCards.add(new MonsterCard("The Calculator", "Model.Effect", "Thunder", 2,
        ...
        allMonsterCards.add(new MonsterCard("Alexandrite Dragon", "Normal", "Dragon", 4,
                ...
                Attribute.LIGHT, 2000, 100, 2600));
        allMonsterCards.add(new MonsterCard("Mirage Dragon", "Model.Effect", "Dragon", 4,
                "Your opponent cannot activate Trap Cards during the Battle Phase.",
                Attribute.LIGHT, 1600, 600, 2500));
        allMonsterCards.add(new MonsterCard("Herald of Creation", "Model.Effect", "Spellcaster", 4,
                ...
                Attribute.LIGHT, 1800, 600, 2700));
        allMonsterCards.add(new MonsterCard("Exploder Dragon", "Model.Effect", "Dragon", 3,
        ...
        allMonsterCards.add(new MonsterCard("Warrior Dai Grepher", "Normal", "Warrior", 4,
                ...
                Attribute.EARTH, 1700, 1600, 3400));
        ...
        allMonsterCards.add(new MonsterCard("Wattaildragon", "Normal", "Dragon", 6,
                ...
                Attribute.LIGHT, 2500, 1000, 5800));
        allMonsterCards.add(new MonsterCard("Terratiger, the Empowered Warrior", "Model.Effect", "Warrior", 4,
                "When this card is Normal Summoned: You can Special Summon 1 Level 4 or lower Normal Monster " +
                        "from your hand in Defense Position.", Attribute.EARTH, 1800, 1200, 3200));
        allMonsterCards.add(new MonsterCard("The Tricky", "Model.Effect", "Spellcaster", 5,
                "You can Special Summon this card (from your hand) by discarding 1 card.",
                Attribute.WIND, 2000, 1200, 4300));
        allMonsterCards.add(new MonsterCard("Spiral Serpent", "Normal", "Sea Serpent", 8,
                ...
                Attribute.WATER, 2900, 2900, 11700));
        allMonsterCards.add(new MonsterCard("Command Knight", "Model.Effect", "Warrior", 4,
